...
- Add Visual Polish standalone page with animated sidebar, polished home screen, and search ([#4](https://github.com/sicheng-lu/OUI-next-navigation/pull/4))
...
- Update Popover to capture click event outside to dismiss Popover ([#1647](https://github.com/opensearch-project/oui/pull/1647))
...
- Add bookmark, generate icons ([#1604](https://github.com/opensearch-project/oui/pull/1604))
