...
function NavPanel({ onCollapse, spinKey, dark, navPopover, openNavPopover, closeNavPopover, setNavPopover, themeContext, appearanceSelection, setAppearanceSelection, onCreateSession, onBrowseSessions, sessions, activeSessionId, onSelectSession }) {
  const t = dark ? DARK : LIGHT;
